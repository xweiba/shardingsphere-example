...
DROP DATABASE IF EXISTS ds_master_0_slave_0;
DROP DATABASE IF EXISTS ds_master_0_slave_1;
DROP DATABASE IF EXISTS ds_master_1_slave_0;
DROP DATABASE IF EXISTS ds_master_1_slave_1;

CREATE DATABASE ds_master_0;
CREATE DATABASE ds_master_1;
CREATE DATABASE ds_master_0_slave_0;
CREATE DATABASE ds_master_0_slave_1;
CREATE DATABASE ds_master_1_slave_0;
CREATE DATABASE ds_master_1_slave_1;
