...
package example.shardingsphere.service;

import example.shardingsphere.entity.Address;
import example.shardingsphere.entity.Order;
import example.shardingsphere.entity.OrderItem;
import example.shardingsphere.repository.AddressRepository;
import example.shardingsphere.repository.OrderItemRepository;
import example.shardingsphere.repository.OrderRepository;
...
//            this.cleanEnvironment();
    ...
    private void printDataByUserId() {
        LOGGER.info("---------------------------- Print BY UserId Data -----------------------");
        for (int i = 1; i <= 10; i++) {
            this.orderRepository.selectByUserId(i);
            this.orderItemRepository.selectByUserId(i);
            this.addressRepository.selectByUserId(10, i, new Address());
        }
    }
